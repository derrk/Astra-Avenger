class TitleScene extends Phaser.Scene {
    ...
    preload(){
        this.load.image('infobutton', './assets/info.png');
        this.load.image('mainbg', './assets/mainmenubg.jpg');
    }

    create() {
        this.add.image(225, 400, 'mainbg');

        let infobutton = this.add.image(420, 30, 'infobutton');
